...
const websites = {
	...
	"看片狂人": {"url": "https://www.kpkuang.fun/vodsearch/-------------.html?wd={}", "selector": "div.fed-main-info .fed-part-case div.fed-main-info div.fed-part-case a.fed-deta-play", "base_url": "https://www.kpkuang.fun"},
...
app.get('/search', async (req, res) => {
    ...
    const results = {};
    for (const [name, metadata] of Object.entries(websites)) {
        const links = await scrapePage(metadata.url, metadata.base_url, metadata.selector, query);
        results[name] = links;
    }
